...
test("renders inline code with custom styling", () => {
  ...
  expect(codeElement.className).toContain("px-1.5");
  expect(codeElement.className).toContain("py-0.5");
  expect(codeElement.className).toContain("rounded");
  expect(codeElement.className).toContain("bg-white/[0.08]");
  expect(codeElement.className).toContain("text-violet-300");
